export const ERROR_REPO_NOT_FOUND = 'Cannot find the repo, please check the template and language you type';

export const ERROR_PM_NOT_FOUND = 'All PackageManager(yarn, pnpm, npm) no found, Please check the context';
